      ...
      <div className="container mx-auto p-4">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-base-100 p-4 rounded-lg shadow">
            <h3 className="font-bold mb-3 text-green-400">
              📱 For Drivers (Mobile GPS)
            </h3>
            <p className="text-sm mb-3 text-base-content/70">
              Send your location from mobile phone:
            </p>
          ...
          <div className="bg-base-100 p-4 rounded-lg shadow">
            <h3 className="font-bold mb-3 text-blue-400">
              🖥️ For Managers (Web View)
            </h3>
            <p className="text-sm mb-3 text-base-content/70">
              Monitor vehicles from web browser:
            </p>
            <div className="space-y-2">
              <a
        ...
        <div className="mt-6 bg-yellow-900/20 border border-yellow-700 p-4 rounded-lg">
          ...
          <ol className="list-decimal ml-5 space-y-1 text-sm text-base-content/70">
            <li>
              Drivers: Open GPS Tracker link on mobile phone → Allow location
              access → Tracking starts automatically
            </li>
            <li>
              Managers: Open Map Viewer link → See real-time vehicle locations
              with auto-refresh
            </li>
            <li>
              Use "Local" links for testing, "External" links work from anywhere
              on internet
            </li>
          </ol>
        </div>
